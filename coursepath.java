...
public class HttpClientTest {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// Scoring request
			URL scoringUrl = new URL("https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/bbb10d7b-b104-497b-ab99-e0a1ac292a24/ai_service_stream?version=2021-05-01");
